...
describe User, type: :model do
  ...
  describe 'admin presence validation' do
    ...
    context 'when is blank' do
      ...
      it 'adds error to the :admin field' do
        expect(user.errors[:admin]).to eq ['is not present']
      end
    end
    ...
    context 'when is not blank' do
      ...
      it 'does not add error to the :admin field' do
        expect(user.errors[:admin]).to eq nil
      end
    end
  end
